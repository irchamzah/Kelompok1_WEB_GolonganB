          ...
          <div class="card-body">
            ...
            <form method="POST" action="{{ url('profil') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="alamat" type="alamat" class="form-control @error('alamat') is-invalid @enderror" name="alamat" value="{{ $user->alamat }}" required autocomplete="alamat">{{ $user->alamat }}</textarea>
