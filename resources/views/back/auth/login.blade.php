    ...
    <form class="login-form" method="POST" action="{{route('admin.login')}}" novalidate>
      ...
      <div class="login-wrap">
        ...
        <div class="input-group">
          ...
          <input type="text" class="form-control @error('email') is-invalid @enderror" id="inputEmailAddress" placeholder="Isi Email Anda" name="email" value="{{old('email')}}" autofocus>
          @error('email')
        ...
        <div class="input-group">
          ...
          <input type="password" class="form-control @error('email') is-invalid @enderror" placeholder="Isi Password Anda" name="password">
          @error('password')
          <span class="invalid-feedback"><strong>{{$message}}</strong></span>
        @enderror
        </div>
